...
@test_throws ArgumentError crowded_cows1([7,3,4,2,3,10,4], 10)
@test crowded_cows1([7,3,4,2,3,10,4], 3) == 3
@test crowded_cows1([7,3,4,2,3,4], 3) == 4
@test crowded_cows1([7,3,1,0,4,2,16,28,3,4],3) == -1
println("All unit tests passed.")

# cows = int(readdlm("cows.txt"))
println("Testing on input file...")
cows = int(readdlm(ARGS[1]))
println(string("Time used: ", ( @elapsed crowded_cows1(cows, 25000)), " seconds."))
println(string("Maximum breed id of a pair of crowded cows: ",crowded_cows1(cows, 25000)))
